...
DROP PROCEDURE IF EXISTS getManufacturerId;

DELIMITER //

CREATE PROCEDURE getManufacturerId(IN p_name varchar(64), OUT p_id int, OUT p_bIsOk boolean) 
BEGIN 
declare iStart int;
declare iEnd int;
...
IF p_id > 0 THEN
    ...
    IF NOT EXISTS (SELECT * FROM temp_manufacturer_to_store) THEN
